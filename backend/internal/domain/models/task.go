...
var TaskWhere = struct {
	...
	UserID:      whereHelperuint64{field: "`task`.`user_id`"},
	Title:       whereHelperstring{field: "`task`.`title`"},
	Description: whereHelpernull_String{field: "`task`.`description`"},
	DueDate:     whereHelpernull_Time{field: "`task`.`due_date`"},
	Completed:   whereHelperbool{field: "`task`.`completed`"},
...
var (
	taskAllColumns            = []string{"id", "user_id", "title", "description", "due_date", "completed", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"user_id", "title", "description", "due_date"}
	taskColumnsWithDefault    = []string{"id", "completed", "created_at", "updated_at"}
